...
import {
  limparCredenciaisLoginTemporarias,
  obterCredenciaisLoginTemporarias,
} from "../services/credenciaisLoginTemporarias";
  ...
  useEffect(() => {
    ...
    const inicializarLogin = async () => {
      try {
        ...
        const credenciaisDoCadastro =
          obterCredenciaisLoginTemporarias();

        if (credenciaisDoCadastro) {
          setEmail(credenciaisDoCadastro.email);
          setSenha(credenciaisDoCadastro.senha);
          setLembrarMe(false);
